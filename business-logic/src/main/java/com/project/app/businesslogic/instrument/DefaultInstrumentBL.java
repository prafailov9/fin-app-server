package com.project.app.businesslogic.instrument;

import com.project.app.businesslogic.exceptions.EntityValidationException;
...
public class DefaultInstrumentBL implements InstrumentBL {
    ...
    public void insertInstrument(Instrument instrument) {
        ...
        } catch (CannotPersistEntityException | EntityValidationException ex) {
